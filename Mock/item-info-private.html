...
<div class="alert2" role="alert">
  ...
  <div class="card-body">
    ...
    <p class="card-text">撥水性と通気性を両立させた生地を使い、雨の日も晴れた日も湿気で蒸れにくい汎用性の高いパーカーになっております。</p>
     <p class="card-text">価格：10000円</p>
     <a href="C:\Users\tatsu\Documents\git\MyWebSite\Mock\cart-private.html" class="btn2 btn-outline-info ">カートに追加<i class="fas fa-cart-plus"></i></a>
   </div>
