...
public class EcHelper {
	...
	// 商品管理マスタ管理
	static final String ITEM_MASTER_PAGE = "/jsp/item-list-master.jsp";
	// 商品情報確認/更新
	static final String ITEM_MASTERINFO_PAGE = "/jsp/item-master-info.jsp";
	// 商品新規登録
	static final String ITEM_REGISTRATION_MASTERINFO_PAGE = "/jsp/item-registration-master.jsp";
